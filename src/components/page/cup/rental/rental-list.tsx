...
const RentalList = () => {
  ...
  const { data, error, isLoading, mutate } = useRentals({
    ...
    fromMachineId: router.query.fromMachineId ? String(router.query.fromMachineId) : undefined,
    toMachineId: router.query.toMachineId ? String(router.query.toMachineId) : undefined,
